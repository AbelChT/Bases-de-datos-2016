...
--SELECT * FROM partido WHERE rownum = 1;
--SELECT * FROM equipo WHERE nombre_oficial = 'Ath. Bilbao';
--UPDATE partido SET goles_local = 1 WHERE rownum = 1;
--UPDATE partido SET goles_local = 4 WHERE rownum = 1;
-- J20 T20 Sabadell(local)
--SELECT * FROM empates WHERE temporada = 6 AND equipo = 'Sabadell';
--DELETE FROM partido;
--DELETE FROM empates;
--DELETE FROM media_goles;
